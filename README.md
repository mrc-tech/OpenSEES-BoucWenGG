...
## Usage (TLC):
Include [`BoucWenGG.dll`](/releases/latest/download/BoucWenGG.dll) file inside the same folder of the TCL model file to use the material. The material can be defined by the TCL command:
```tcl
