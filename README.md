...
## Usage (TLC):
Include [`BoucWenGG.dll`](https://github.com/mrc-tech/OpenSEES-BoucWenGG/releases/latest/BoucWenGG.dll) file inside the same folder of the TCL model file to use the material. The material can be defined by the TCL command:
```tcl
